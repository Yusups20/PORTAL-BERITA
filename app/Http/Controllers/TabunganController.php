...
class TabunganController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $tabungan->save();
        return redirect()->route('tabungan.index')->with(['message'=>'DATA SISWA BERHASIL DI SIMPAN']);;
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $tabungan->jumlah_uang = $request->jumlah_uang;
        $tabungan->save();
        return redirect()->route('tabungan.index')->with(['message'=>'DATA SISWA BERHASIL DI EDIT']);;
    }
    ...
    public function destroy($id)
    {
        $tabungan = Tabungan::findOrFail($id);
        $tabungan->delete();
        return redirect()->route('tabungan.index')->with(['message'=>'DATA SISWA BERHASIL DI HAPUS']);;
    }
}
